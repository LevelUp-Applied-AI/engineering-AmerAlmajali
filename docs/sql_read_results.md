...
[ 2024A , This tells us that differences between cohorts are related to both the year and the class—so some years/classes (like 2024A) may be better prepared or have stronger students compared to others (like 2024B or 2025A).]
...
[There are 8 students who scored 80 or above. I am not surprised that most of them are from Jordan because I am familiar with my country and the mentality and academic commitment of our people]
...
[Looking at Aisha Al-Rashidi (2024A) from Query 4:
Submitted all three projects on time: Laptop Verify (95), Python Env (88), PR Hygiene (92)
This pattern shows she is consistent, punctual, and performs well across different tasks, indicating a highly responsible and capable learner.]